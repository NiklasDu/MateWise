    ...
    <section class="bg-white dark:bg-gray-900">
      <div className="container px-4 mx-auto max-w-screen-lg py-10">
        <div class="flex items-center gap-x-3">
          ...
          <span class="px-3 py-1 text-sm text-emerald-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-emerald-400">
            0 neue
          </span>
        </div>
        ...
        <div class="flex items-center justify-between mt-6">
          ...
          <div class="items-center hidden lg:flex gap-x-3">
            <a
              href="#"
              class="px-2 py-1 text-sm text-emerald-500 rounded-md dark:bg-gray-800 bg-blue-100/60"
            >
              1
            </a>
            <a
