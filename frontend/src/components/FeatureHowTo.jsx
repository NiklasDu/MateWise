        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="container max-w-screen-xl px-16 py-10 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                    <div class="p-8 space-y-3 border-2 border-emerald-600 dark:border-emerald-300 rounded-xl">
                        <span class="inline-block text-emerald-600 dark:text-emerald-400">
                    ...
                    <div class="p-8 space-y-3 border-2 border-emerald-600 dark:border-emerald-300 rounded-xl">
                        <span class="inline-block text-emerald-600 dark:text-blemeraldue-400">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
